...
{
    public class EffectLinkLabel : LinkLabel
    {
        bool designmode = false;

        public EffectLinkLabel()
        {
            DoubleBuffered = true;
        ...
        protected override void OnPaint(PaintEventArgs e)
        {
            ...
            using (var f = new Font(Font, Font.Style | FontStyle.Underline))
            {
                if (useShadow)
                    TextRenderer.DrawText(e.Graphics, Text, f, new Rectangle(new Point(shadowOffsetX, 0 + shadowOffsetY), Size), shadowColor, flags);

                TextRenderer.DrawText(e.Graphics, Text, f, new Rectangle(new Point(0, 0), Size), LinkColor, flags);
            }
        }
        ...
        public override Size GetPreferredSize(Size proposedSize)
        {
            ...
            if (useShadow)
            {
                ...
                return new Size(sz.Width + shadowOffsetX, sz.Height + shadowOffsetY);
            }
